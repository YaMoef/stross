...
namespace Stross.SubsonicModels
{
    ...
    public partial class Podcasts
    {
        ...
        private System.Collections.Generic.List<PodcastChannel> _channel;
        
        [System.Xml.Serialization.XmlElementAttribute("channel")]
        public System.Collections.Generic.List<PodcastChannel> Channel
        {
            get
            {
                return _channel;
        ...
        public Podcasts()
        {
            this._channel = new System.Collections.Generic.List<PodcastChannel>();
        }
    }
}
