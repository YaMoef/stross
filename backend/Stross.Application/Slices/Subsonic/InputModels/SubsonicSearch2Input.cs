...
public sealed class SubsonicSearch2Input
{
...
public sealed class SubsonicSearch2InputValidator : AbstractValidator<SubsonicSearch2Input>
{
    public SubsonicSearch2InputValidator()
    {
        RuleFor(x => x.Query)
            .NotEmpty()
